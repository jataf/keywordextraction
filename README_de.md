...
Mit der von spacy aufgeführten Aktion nlp = spacy.load('de_core_news_sm') konnte in unserem Fall das Sprachmodell nicht geladen werden. Um das Sprachmodell erfolgreich zu laden, sollte der dazugehörigen Dateipfad mit angegeben werden.
